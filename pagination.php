	...
	<table class="table table-striped table-hover">
	  <thead>
	    <tr>
	      ...
	      <th>Datum dipl.</th>
	      <th class="mobile-hide">Radno mesto</th>
...
?>
	    <tr>
	      <td><center><a href="<?php echo $link; ?>"><img style="width:50px; border-radius: 50px" src="<?php echo $foto_link; ?>" alt="x"></a></center></td>
	      <td><?php echo $ime; ?></td>
	      <td class="mobile-hide"><?php echo $smer; ?></td>
	      <td><?php echo $datum; ?></td>
	      <td class="mobile-hide"><?php echo $radnomesto; ?></td>
